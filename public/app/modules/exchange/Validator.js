...
ExchangeValidator.prototype = {
	validateSecInfo: function(ord) {
        ...
        if (ord.price > 0 && ord.price < secs[0].floor && ord.type != Session.ATO) return ErrorCode.EX_02;
        if (ord.price > 0 && ord.price > secs[0].ceil && ord.type != Session.ATO) return ErrorCode.EX_03;
