...
result = Place(0001000001, AAA, Buy, LO, 50000, 100) # Place order with account 1, Symbol AAA, Price 50000 and Quantity 100
...
result = Place(0001000001, AAA, Buy, LO, 5000, 100)
Assert(result.msg, Price must larger than floor price)

result = Place(000100000123, AAA, Buy, LO, 15000, 100)
Assert(result.msg, Account not exist)

result = Place(0001000001, XXX, Buy, LO, 15000, 100)
Assert(result.msg, Symbol not exist)

result = Place(0001000001, AAA, Buy, LO, 15000, 100000)
Assert(result.msg, Don't enough balance)

result = Place(0001000001, AAA, Sell, LO, 15000, 10000)
